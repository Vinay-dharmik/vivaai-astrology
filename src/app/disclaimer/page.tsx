  ...
  return (
    <div className="section-container py-12 max-w-3xl mx-auto">
      ...
      <div className="glass-card p-6 sm:p-8 space-y-5 text-[var(--text-secondary)] leading-relaxed text-sm">
        ...
        <p>Our platform uses the <strong className="text-white">Astronomy Engine</strong> library with <strong className="text-gold-200">Lahiri Ayanamsa</strong> for planetary position calculations. These astronomical computations are mathematically precise and match professional astrology software to within 0.01° accuracy. However, the accuracy of your personal birth chart depends on the precision of the birth details you provide:</p>
